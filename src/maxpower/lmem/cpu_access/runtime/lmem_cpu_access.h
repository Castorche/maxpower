...
extern lmem_cpu_access_t *init_lmem_cpu_access(max_file_t *maxfile, max_engine_t *engine);
extern size_t lmem_get_burst_size_bytes(lmem_cpu_access_t *handle);
extern void lmem_write(lmem_cpu_access_t *handle, uint32_t address_bursts, void *data, size_t data_size_bursts);
